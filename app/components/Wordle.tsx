...
export default function Wordle() {
  ...
  return <div key={key} className="border border-gray-400 rounded-lg p-4 w-full max-w-md text-center">
    {wordle.gameWon
    ...
    : wordle.index >= wordle.tries
      ...
      : null}
    {Array.from({length: wordle.tries}, (_, y) => <WordleRowCompute
      key={`${key}-row-${y}`}
      active={y == wordle.index}
    />)}
  </div>
}
